...
public class App {
	...
	public static void main(String[] args) {
		...
		// The ofLocalizedDate() will return a formatter.
		
		/*
		 * FormatStyle enum contains the style of formatting.
		 * 
		 * FULL : Full text style, with the most detail. Ex: 'Tuesday, April 12, 1952 AD' or '3:30:42pm PST'.
           LONG : Long text style, with lots of detail.  Ex: 'January 12, 1952'.
           MEDIUM : Medium text style, with some detail. Ex: 'Jan 12, 1952'.
           SHORT:Short text style, typically numeric.    Ex: '12.13.52' or '3:30pm'. * 
		 * 
		 */
		...
		System.out.println("shortDate: " + date1.format(shortDate)); // format(vehicle): Formats this date-time using the specified formatter.																		
		...
		LocalDateTime m2DateTime = LocalDateTime.of(m2Date, m2Time).minusDays(1).minusHours(11); // date and time methods chained
